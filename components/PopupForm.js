      ...
      >
        ...
        >
          <form action="https://submit-form.com/OkZ4UNir" className="space-y-4">
            ...
            htmlFor="mission"
            className="block font-medium text-gray-700">
                Mission (Max 80 characters)*</label>
            <textarea
              type="text"
              id="mission"
              name="mission"
            ...
            <div>
            <label htmlFor="X"
            className="block  font-medium text-gray-700">X (Twitter)</label>
            <input 
            type="text" 
            id="X" 
            name="X"
            ...
            className="block  font-medium text-gray-700" >Discord</label>
            <input 
            type="text"
            id="discord"
            name="discord"
            ...
            className="block font-medium text-gray-700" >Application Link*</label>
            <input 
              type="text"
              id="applicationLink"
            ...
            <div>
            <label htmlFor="Token link"
            className="block font-medium text-gray-700" >Token or NFT</label>
            <input 
              type="text"
              id="token"
              name="token"
            ...
            <div>
            <label htmlFor="Email"
            className="block font-medium text-gray-700">Email (Internal use only)*</label>
            <input
              type="email"
              id="email"
              name="email"
